...
**Amendments during build:** Mang Inasal failed Riyadh re-verification (Philippines-only) and was replaced by Wakame (verified, wakame-ksa.com). **2026-07-11:** at the user's request, 19 chains were removed from the shipped roster — Shake Shack, Fatburger, BurgerFuel, Hamburgini, The Real Burger, Taxi, Salt, Nevermind, ChicKing, PAO, Crust Corner, Shawarma Plus, Shawarmasters, Shawarmix, Shawarma Factory, Assaraya Turkish Restaurant, Meat Moot, London Fish & Chips, Wakame — leaving 81 chains / ~540 items. **Later on 2026-07-11:** Fuddruckers and Buffalo Wings & Rings also removed, and 13 chains added at the user's request (all verified operating in Riyadh): Wendy's, NYF (New York Fries), Dawar Alsaada, CasaPasta, Pizzaratti, Let's Pizza, Oven of Damascus Patties, ALLIWAN, Saldwich, Lolivo, BROASTEDkey, Kantaka, Broast Line — then Dank Sandwich removed as well — final roster **91 chains / ~597 items** (roster-lock tests updated accordingly). **HungerStation expansion, 2026-07-11:** existing chains expanded with delivery-menu items carrying SFDA calorie labels (sanity-checked item by item; per-100g/per-slice/blindly-filled labels rejected), and 3 chains added at the user's request: BLABAN, IHOP, Half Million. Dots was approved but skipped — its HungerStation menu has no calorie labels on food items. Roster now **94 chains** (roster-lock test updated). **Full-menu audit + expansion, 2026-07-12:** every chain's items and prices were reconciled against its live HungerStation Malqa menu — nearly all pre-audit blocks turned out fabricated and were rebuilt from real HS calorie labels (macros back-computed, `estimated: true`); chains added at the user's request during the sweep include Fire Grill, Shawermat Furn Al Dayaa, Shawayet Alkhaleej, Burger King, Masami Sushi, Red Box, Oiso Sushi, Calo, California Burger, Shawerma Ajibah, Raeq, Pho', Najm Alshawarma, Black Barn, Alqandil Althahabi, Usta Asim, Jollibee and more. Johnny Rockets and Malak Al Tawouk were removed (not on HungerStation Malqa; user-approved 2026-07-12). Items may now carry a per-item `cuisine` override (a pizza at a shawarma chain surfaces under the pizza filter), and the five full-menu Levantine restaurants (Barbar, Zaatar w Zeit, Allo Beirut, Operation Falafel, Bayt Alfatirah Aldimashqia) moved to a new **levantine** cuisine chip while their shawarma dishes stay under shawarma. Final roster **96 chains / ~2,958 items** (roster-lock test updated to 2,500–3,500).
