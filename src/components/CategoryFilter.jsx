...
const ICONS = {
  ...
  pasta: <path d="M8 3v5M12 3v5M16 3v5M8 6h8M12 8v13M5 16c2.5-2.5 11.5-2.5 14 0M7 19.5c2-2 8-2 10 0" />,
  shawarma: <path d="M9 3h6l-1.5 17h-3L9 3zM8 7h8M8.5 11h7M9 15h6" />,
  lebanese: <path d="M12 4a8 8 0 1 1 0 16 8 8 0 0 1 0-16zM9.5 10v.01M14.5 9.5v.01M11 14v.01M14.5 13.5v.01" />,
